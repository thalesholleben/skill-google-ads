# AGENTS.md — Google Ads Manager Skill
...
A Claude Code skill for advanced Google Ads management in 2026. It is **not a web app, API, or runnable service** — it is a skill package: structured knowledge files + Python scripts that an AI agent loads to perform Google Ads strategy work.
...
- **Never store credentials here** — no Google Ads API keys, OAuth tokens, account IDs, or customer secrets belong in this repository.
